...
RobotVoice::RobotVoice()
{
    ...
    //command_pub = nh.advertise < std_msgs::Int32 > ("/calendar/command", 3);
	 ...
	 french_sub_ = nh.subscribe < std_msgs::String > ("/ROBOT/french_voice", 5, &RobotVoice::frenchCallback, this);
	 english_sub_ = nh.subscribe < std_msgs::String > ("/ROBOT/english_voice", 5, &RobotVoice::englishCallback, this);
}


void RobotVoice::frenchCallback(const std_msgs::String::ConstPtr & feedback)
{
	char my_buff[256];
        //cout << buff;
...
void RobotVoice::englishCallback(const std_msgs::String::ConstPtr & feedback)
{
        char my_buff[256];
        //cout << buff;
