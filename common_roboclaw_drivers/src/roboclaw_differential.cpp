...
class RoboClaw
{
    ...
    private:
        ...
        void write_RoboClaw_speed_dist_M1M2(char addr, int32_t speedM1,
                int32_t distanceM1,
                int32_t speedM2,
                int32_t distanceM2);        
...
{	
    ...
    nhp.param<int>("serial_port_number", _port_number, 128);
    ...
    write_RoboClaw_PID_M1(_port_number, P, I, D, Q); 
    write_RoboClaw_PID_M2(_port_number, P, I, D, Q);
}
...
void RoboClaw::linearSpeedCallback(const std_msgs::Float32::ConstPtr& msg)
{
    ...
    _linear_value = msg->data * _lin_coeff;

    speed_motor1 = _linear_value - _angular_value;
    speed_motor2 = _linear_value + _angular_value;

    write_RoboClaw_speed_M1M2(_port_number, int32_t(_motor1_side*speed_motor1), int32_t(_motor2_side*speed_motor2));
}
...
// Used to change the speed value of motor 1 and 2 during a specific distance
void RoboClaw::write_RoboClaw_speed_dist_M1M2(char addr, int32_t speedM1,
        int32_t distanceM1,
        int32_t speedM2,
        int32_t distanceM2)
{
